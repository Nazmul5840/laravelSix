...
<html lang="en">
    ...
    <body>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{route('post')}}">Write Post</a></li>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url({{asset('public/frontend/assets/img/home-bg.jpg') }})">
       ...
       <script>
         function dltfunction(){
            //e.preventDefault();
            var result=confirm("Are you want to delete it?");
